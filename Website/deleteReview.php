                            ...
                            <div class="card-body p-md-0" style="background-color: #f8f9fa;">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-7 col-xl-7 order-2 order-lg-1">
                                        ...
                                        <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-1 mt-3">Delete Review</p>

                                        <form class="mx-1 mx-md-4" method="post" action="doDeleteReview.php">
...
<!--
                                            <div class="d-flex flex-row align-items-center mb-4 justify-content-center">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <label class="form-label"><b>Comments:</b></label><br/><?php echo $rowItem['review'] ?>
                                                </div>
                                            </div>
-->
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                                <div class="form-outline flex-fill mb-0">
                                                    <center><label class="form-label"><b>Comments:</b><br/> 
                                                        </label><?php echo $rowItem['review'] ?></center>
                                                </div>
                                            </div>

                                            <div class="d-flex flex-row align-items-center mb-4 justify-content-center">
                                                <label for="editRating"><b>Rating:</b> </label><br/>
                                                <center>
                                                    <?php echo $rating ?>
                                                </center>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                                <button type="submit" value="<?php echo $rowItem['reviewId'] ?>" name="id" class="btn btn-dark btn-lg">Delete Review</button>
                                            </div>
